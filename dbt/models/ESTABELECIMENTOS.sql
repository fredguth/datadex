...
FROM {{ source('raw', 'TB_UNIDADE_CENTRO_CUSTO') }} DUC
    LEFT JOIN {{ source('raw', 'TB_TIPO_UNIDADE') }} DTT ON DUC.CO_TIPO_UNIDADE = DTT.CO_SEQ_TIPO_UNIDADE
    LEFT JOIN {{ source('raw', 'TB_TIPO_PRESTADOR') }} DTPREST ON DUC.CO_TIPO_PRESTADOR = DTPREST.CO_SEQ_TIPO_PRESTADOR
